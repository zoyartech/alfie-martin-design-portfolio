    ...
    <div className="min-h-screen bg-white font-sans text-slate-800 antialiased selection:bg-blue-100 selection:text-blue-900">
      ...
      <div className="pt-24 pb-20">
        ...
        <div className="max-w-5xl mx-auto px-6 py-12 md:py-20 border-t border-gray-100">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <div className="bg-[#b8daf2] p-8 md:p-10 rounded-sm">
              ...
              <p className="font-sans text-slate-700 text-lg  ">
        ...
        <div className="max-w-5xl mx-auto px-6 py-12 md:py-20 border-t border-gray-100">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-16">
            <div className="flex flex-col border border-blue-200">
              ...
              <div className="bg-[#e3f0fa] p-8 flex-grow">
                ...
                <p className="font-sans text-slate-700 text-lg  ">I explored 30+ layout concepts across three paradigms: stacked cards, inline toggles, and tabbed panels. Most of them were bad. That's the point of divergent sketching.</p>
              </div>
            </div>
            <div className="flex flex-col border border-blue-400">
              ...
              <div className="bg-[#e3f0fa] p-8 flex-grow">
                ...
                <p className="font-sans text-slate-700 text-lg  ">I tested 4 mid-fidelity prototypes with 10 users. Stacked cards with visible confidence bars won decisively on comprehension speed. Tabs made people feel like the other answers were hidden. Toggles made people feel like they were doing homework.</p>
              </div>
            </div>
            <div className="flex flex-col border border-[#0a3d82]">
              ...
              <div className="bg-[#153a70] p-8 flex-grow">
                ...
                <p className="font-sans text-white/90 text-lg  ">I partnered with the ML team to define the training data structure: answer text, confidence float, and source URL per candidate. Getting engineering and design to agree on a schema was, as always, a negotiation disguised as a technical conversation.</p>
              </div>
            </div>
            <div className="flex flex-col border border-purple-200">
              ...
              <div className="bg-[#faeffd] p-8 flex-grow">
                ...
                <p className="font-sans text-slate-700 text-lg  ">I designed a feedback loop where users could flag incorrect answers, feeding corrections back into the model's confidence calibration. The chatbot could learn from being wrong, which already put it ahead of most people I've worked with.</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="border-l-[6px] border-[#3b82f6] pl-6 py-1">
              ...
              <p className="font-sans text-slate-700 text-base lg:text-lg  ">Through testing, I found that two answers felt like a coin flip and five felt like a research project. Three gave users a primary recommendation with meaningful alternatives, without triggering decision fatigue. The magic number is real, and it's three.</p>
            </div>
            <div className="border-l-[6px] border-[#3b82f6] pl-6 py-1">
              <h4 className="font-serif text-xl font-bold mb-4 text-slate-900">Confidence as a visual bar, not just a number</h4>
              <p className="font-sans text-slate-700 text-base lg:text-lg  ">Early tests showed that a bare percentage (e.g., "87%") triggered anxiety in some users. They fixated on why it wasn't 100%. A filled bar with a color-coded badge (green, yellow, red) communicated relative confidence more intuitively and reduced that fixation by 40% in follow-up testing. Turns out, humans process "mostly green" faster than they process "eighty-seven percent."</p>
            </div>
            <div className="border-l-[6px] border-[#3b82f6] pl-6 py-1">
              <h4 className="font-serif text-xl font-bold mb-4 text-slate-900">Source citations as anchors, not footnotes</h4>
              <p className="font-sans text-slate-700 text-base lg:text-lg  ">I placed the source directly beneath each answer. Not in a collapsible section. Not at the bottom of the page. Not behind a "learn more" link that nobody clicks. The citation needed to be inseparable from the claim. This was the single highest-impact decision for perceived trustworthiness in testing, and also the one that required the least engineering effort. Love when that happens.</p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-6 py-12 md:py-20 border-t border-gray-100">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="bg-[#f4f3ef] p-6 rounded-sm">
              ...
              <p className="font-sans text-slate-700 mb-6 text-lg  ">The maximum contribution limit for a Roth IRA in 2025 is $7,000 for individuals under 50, and $8,000 for individuals 50 and older (with the $1,000 catch-up provision).</p>
            ...
            <div className="bg-[#f4f3ef] p-6 rounded-sm">
              ...
              <p className="font-sans text-slate-700 mb-6 text-lg  ">The 2025 Roth IRA contribution limit is $7,000, though eligibility may phase out for single filers earning above $150,000 (MAGI).</p>
            ...
            <div className="bg-[#f4f3ef] p-6 rounded-sm">
              ...
              <p className="font-sans text-slate-700 mb-6 text-lg  ">The contribution limit may remain at $6,500 for 2025, consistent with the 2023 limit, pending further IRS guidance.</p>
        ...
        <div className="max-w-5xl mx-auto px-6 py-12 md:py-20 border-t border-gray-100">
          ...
          <div className="grid md:grid-cols-3 gap-10 mb-16">
            ...
            <div>
              ...
              <p className="font-sans text-slate-700 text-lg  ">I identified and curated roughly 200 "hard queries," questions with contested answers, recently-changed facts, or inherently ambiguous phrasing, and used them as a stress-test set for the model's confidence ranking. These queries exposed calibration drift early and became a standing regression suite. They were the trick questions on the exam, and the model needed to learn to say "I'm not sure" instead of guessing confidently.</p>
            </div>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-6 py-12 md:py-20 border-t border-gray-100">
          ...
          <div className="font-sans text-slate-700 text-xl   space-y-8">
