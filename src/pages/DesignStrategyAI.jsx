    ...
    <div className="min-h-screen bg-white font-sans text-slate-800 antialiased selection:bg-blue-100 selection:text-blue-900">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-sm border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex items-center justify-between h-20">
            <Link to={createPageUrl("Home")} className="text-sm tracking-[0.3em] font-medium text-black">
              ALFIE MARTIN
            </Link>
      ...
      <div className="pt-24 pb-20">
        ...
        <div className="max-w-5xl mx-auto px-6 py-12 md:py-20">
          ...
          <h2 className="font-serif text-5xl md:text-6xl font-bold mb-8 text-gray-900 tracking-tight">
            The Problem With Single-Answer Chatbots
          </h2>
          <div className="font-sans text-gray-800 text-lg md:text-xl leading-relaxed space-y-6">
            ...
            <p className="font-bold italic text-gray-900">what if, instead of cosplaying omniscience, the chatbot just showed its work?</p>
            <p className="font-bold italic text-gray-900">Surface three candidate answers?</p>
            <ul className="list-disc pl-8 space-y-2 font-bold text-gray-900">
            ...
            <p className="font-bold italic text-gray-900 pt-2">The bet was that transparency would do what a thousand "I'm confident in this answer!" microcopy strings never could: actually build trust.</p>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-6 py-12 md:py-20 border-t border-gray-100">
          ...
          <h2 className="font-serif text-5xl md:text-6xl font-bold mb-12 text-gray-900 tracking-tight">
            Understanding the Trust Deficit
          </h2>
          
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <div className="bg-[#b8daf2] p-8 md:p-10 rounded-sm">
              <h3 className="font-serif text-3xl font-bold mb-4 text-gray-900">What I Did</h3>
            ...
            <div className="p-4 md:p-10 flex flex-col justify-center">
              <h3 className="font-serif text-3xl font-bold mb-4 text-gray-900">What I Found</h3>
              <p className="font-sans text-gray-800 text-lg leading-relaxed">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16 text-center">
            <div>
              ...
              <p className="font-serif text-xl font-bold text-gray-900 mb-2">Cross-referenced externally</p>
              <p className="font-sans text-gray-600 text-sm leading-relaxed">Users verified answers with an external source before acting</p>
            </div>
            <div>
              <p className="font-serif text-5xl text-gray-700 mb-4 font-light">3.2×</p>
              <p className="font-serif text-xl font-bold text-gray-900 mb-2">Higher abandonment</p>
              <p className="font-sans text-gray-600 text-sm leading-relaxed">On low-confidence queries</p>
            </div>
            <div>
              <p className="font-serif text-5xl text-gray-700 mb-4 font-light">14</p>
              <p className="font-serif text-xl font-bold text-gray-900 mb-2">Usability sessions</p>
              <p className="font-sans text-gray-600 text-sm leading-relaxed">Conducted across three user segments</p>
            </div>
            <div>
              <p className="font-serif text-5xl text-gray-700 mb-4 font-light">78%</p>
              <p className="font-serif text-xl font-bold text-gray-900 mb-2">Wanted options</p>
              <p className="font-sans text-gray-600 text-sm leading-relaxed">Not pronouncements — users wanted "a second opinion"</p>
            </div>
          </div>

          <div className="font-serif text-2xl md:text-3xl text-gray-900 leading-relaxed space-y-6 max-w-4xl">
        ...
        <div className="max-w-5xl mx-auto px-6 py-12 md:py-20 border-t border-gray-100">
          ...
          <h2 className="font-serif text-4xl md:text-5xl font-bold mb-4 text-gray-900 tracking-tight">
            From Concept to Confidence Ranking
          </h2>
          
          <h3 className="font-serif text-2xl font-bold mb-4 text-gray-900 mt-6">Framing the Output Model</h3>
          <p className="font-sans text-gray-800 text-lg mb-12 leading-relaxed">
          ...
          <h3 className="font-serif text-3xl font-bold mb-6 text-gray-900">Exploration</h3>
          <div className="grid md:grid-cols-2 gap-6 mb-16">
            <div className="flex flex-col border border-blue-200">
              <div className="bg-[#99c4f1] py-3 text-center text-xl font-serif text-gray-900">1</div>
              <div className="bg-[#e3f0fa] p-8 flex-grow">
                <h4 className="font-serif text-xl font-bold mb-4 text-gray-900">Divergent Sketching</h4>
                <p className="font-sans text-gray-800 text-lg leading-relaxed">I explored 30+ layout concepts across three paradigms: stacked cards, inline toggles, and tabbed panels. Most of them were bad. That's the point of divergent sketching.</p>
              </div>
            </div>
            <div className="flex flex-col border border-blue-400">
              ...
              <div className="bg-[#e3f0fa] p-8 flex-grow">
                <h4 className="font-serif text-xl font-bold mb-4 text-gray-900">Concept Testing</h4>
                <p className="font-sans text-gray-800 text-lg leading-relaxed">I tested 4 mid-fidelity prototypes with 10 users. Stacked cards with visible confidence bars won decisively on comprehension speed. Tabs made people feel like the other answers were hidden. Toggles made people feel like they were doing homework.</p>
              </div>
            </div>
            <div className="flex flex-col border border-[#0a3d82]">
              ...
              <div className="bg-[#153a70] p-8 flex-grow">
                ...
                <p className="font-sans text-white/90 text-lg leading-relaxed">I partnered with the ML team to define the training data structure: answer text, confidence float, and source URL per candidate. Getting engineering and design to agree on a schema was, as always, a negotiation disguised as a technical conversation.</p>
              </div>
            </div>
            <div className="flex flex-col border border-purple-200">
              <div className="bg-[#dfb9f3] py-3 text-center text-xl font-serif text-gray-900">4</div>
              <div className="bg-[#faeffd] p-8 flex-grow">
                <h4 className="font-serif text-xl font-bold mb-4 text-gray-900">Calibration Design</h4>
                <p className="font-sans text-gray-800 text-lg leading-relaxed">I designed a feedback loop where users could flag incorrect answers, feeding corrections back into the model's confidence calibration. The chatbot could learn from being wrong, which already put it ahead of most people I've worked with.</p>
              </div>
            </div>
          </div>

          <h3 className="font-serif text-3xl font-bold mb-8 text-gray-900">Key Design Decisions</h3>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="border-l-[6px] border-[#3b82f6] pl-6 py-1">
              <h4 className="font-serif text-xl font-bold mb-4 text-gray-900">Three answers, not two or five</h4>
              <p className="font-sans text-gray-800 text-base lg:text-lg leading-relaxed">Through testing, I found that two answers felt like a coin flip and five felt like a research project. Three gave users a primary recommendation with meaningful alternatives, without triggering decision fatigue. The magic number is real, and it's three.</p>
            </div>
            <div className="border-l-[6px] border-[#3b82f6] pl-6 py-1">
              <h4 className="font-serif text-xl font-bold mb-4 text-gray-900">Confidence as a visual bar, not just a number</h4>
              <p className="font-sans text-gray-800 text-base lg:text-lg leading-relaxed">Early tests showed that a bare percentage (e.g., "87%") triggered anxiety in some users. They fixated on why it wasn't 100%. A filled bar with a color-coded badge (green, yellow, red) communicated relative confidence more intuitively and reduced that fixation by 40% in follow-up testing. Turns out, humans process "mostly green" faster than they process "eighty-seven percent."</p>
            </div>
            <div className="border-l-[6px] border-[#3b82f6] pl-6 py-1">
              <h4 className="font-serif text-xl font-bold mb-4 text-gray-900">Source citations as anchors, not footnotes</h4>
              <p className="font-sans text-gray-800 text-base lg:text-lg leading-relaxed">I placed the source directly beneath each answer. Not in a collapsible section. Not at the bottom of the page. Not behind a "learn more" link that nobody clicks. The citation needed to be inseparable from the claim. This was the single highest-impact decision for perceived trustworthiness in testing, and also the one that required the least engineering effort. Love when that happens.</p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-6 py-12 md:py-20 border-t border-gray-100">
          ...
          <p className="font-sans text-gray-800 text-lg mb-6 leading-relaxed">
          ...
          <p className="font-sans text-gray-800 text-lg mb-10 leading-relaxed">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="bg-[#f4f3ef] p-6 rounded-sm">
              <h4 className="font-serif text-xl font-bold mb-4 text-gray-900 border-b border-gray-200 pb-4">Answer 1 · 94% confidence</h4>
              <p className="font-sans text-gray-800 mb-6 text-lg leading-relaxed">The maximum contribution limit for a Roth IRA in 2025 is $7,000 for individuals under 50, and $8,000 for individuals 50 and older (with the $1,000 catch-up provision).</p>
              <p className="font-sans text-sm text-gray-600 italic leading-relaxed">Source: IRS.gov, Retirement Topics: IRA Contribution Limits (2025)</p>
            </div>
            <div className="bg-[#f4f3ef] p-6 rounded-sm">
              <h4 className="font-serif text-xl font-bold mb-4 text-gray-900 border-b border-gray-200 pb-4">Answer 2 · 72% confidence</h4>
              <p className="font-sans text-gray-800 mb-6 text-lg leading-relaxed">The 2025 Roth IRA contribution limit is $7,000, though eligibility may phase out for single filers earning above $150,000 (MAGI).</p>
              <p className="font-sans text-sm text-gray-600 italic leading-relaxed">Source: NerdWallet, Roth IRA Rules and Limits for 2025</p>
            </div>
            <div className="bg-[#f4f3ef] p-6 rounded-sm">
              <h4 className="font-serif text-xl font-bold mb-4 text-gray-900 border-b border-gray-200 pb-4">Answer 3 · 41% confidence</h4>
              <p className="font-sans text-gray-800 mb-6 text-lg leading-relaxed">The contribution limit may remain at $6,500 for 2025, consistent with the 2023 limit, pending further IRS guidance.</p>
              <p className="font-sans text-sm text-gray-600 italic leading-relaxed">Source: Investopedia, IRA Contribution Limits (2023 Archive)</p>
            </div>
          </div>

          <p className="font-sans text-gray-800 text-lg leading-relaxed mb-16">
        ...
        <div className="max-w-5xl mx-auto px-6 py-12 md:py-20 border-t border-gray-100">
          ...
          <p className="font-sans text-gray-800 text-lg mb-16 leading-relaxed">
          ...
          <h3 className="font-serif text-3xl font-bold mb-10 text-gray-900">My Contributions to Training</h3>
          <div className="grid md:grid-cols-3 gap-10 mb-16">
            <div>
              <h4 className="font-serif text-xl font-bold mb-4 text-gray-900 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-sans text-gray-800 text-lg leading-relaxed">I identified and curated roughly 200 "hard queries," questions with contested answers, recently-changed facts, or inherently ambiguous phrasing, and used them as a stress-test set for the model's confidence ranking. These queries exposed calibration drift early and became a standing regression suite. They were the trick questions on the exam, and the model needed to learn to say "I'm not sure" instead of guessing confidently.</p>
            </div>
          </div>
          ...
          <div className="bg-[#dcf0fb] p-8 md:p-10 flex items-start gap-4 rounded-sm">
            ...
            <div>
              <h4 className="font-serif text-2xl font-bold mb-4 text-gray-900">Key insight from training:</h4>
              <p className="font-sans text-gray-800 text-lg leading-relaxed">
        ...
        <div className="max-w-5xl mx-auto px-6 py-12 md:py-20 border-t border-gray-100">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16 text-center">
            <div>
              ...
              <p className="font-serif text-xl font-bold text-gray-900 mb-2">External verification</p>
              <p className="font-sans text-gray-600 text-sm leading-relaxed">Reduction in external verification behavior</p>
            </div>
            <div>
              <p className="font-serif text-5xl md:text-6xl font-light text-gray-700 mb-4">+33%</p>
              <p className="font-serif text-xl font-bold text-gray-900 mb-2">Answer acceptance</p>
              <p className="font-sans text-gray-600 text-sm leading-relaxed">Increase in answer acceptance rate</p>
            </div>
            <div>
              <p className="font-serif text-5xl md:text-6xl font-light text-gray-700 mb-4">–29%</p>
              <p className="font-serif text-xl font-bold text-gray-900 mb-2">Session abandonment</p>
              <p className="font-sans text-gray-600 text-sm leading-relaxed">Drop in session abandonment on ambiguous queries</p>
            </div>
            <div>
              <p className="font-serif text-5xl md:text-6xl font-light text-gray-700 mb-4">4.7</p>
              <p className="font-serif text-xl font-bold text-gray-900 mb-2">Trust score</p>
              <p className="font-sans text-gray-600 text-sm leading-relaxed">Up from 4.3 on a 5-point Likert scale</p>
            </div>
          </div>
          ...
          <h3 className="font-serif text-3xl font-bold mb-8 text-gray-900">What I'd Do Differently</h3>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="border-l-[6px] border-[#3b82f6] pl-6 py-1">
              <h4 className="font-serif text-xl font-bold mb-4 text-gray-900">Longitudinal calibration study</h4>
              <p className="font-sans text-gray-800 text-lg leading-relaxed">If I were to revisit this work, I'd invest earlier in a longitudinal study of confidence calibration perception. We optimized for first-impression comprehension, but I suspect that over time, power users develop a more nuanced mental model of what the percentages actually mean, and the UI should evolve to meet them there.</p>
            </div>
            <div className="border-l-[6px] border-[#3b82f6] pl-6 py-1">
              <h4 className="font-serif text-xl font-bold mb-4 text-gray-900">User-controlled confidence threshold</h4>
              <p className="font-sans text-gray-800 text-lg leading-relaxed">I'd also explore a user-controlled confidence threshold: let users set a minimum confidence below which answers are suppressed, giving them agency over the noise-to-signal ratio. Some people want three answers. Some people want one good one. The product should be smart enough to accommodate both.</p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-6 py-12 md:py-20 border-t border-gray-100">
          ...
          <div className="border-l-[6px] border-[#3b82f6] pl-6 py-2 mb-10">
            <p className="font-serif text-3xl font-bold text-gray-900">Transparency is not a feature. It is the product.</p>
          </div>

          <div className="font-sans text-gray-800 text-xl leading-relaxed space-y-8">
