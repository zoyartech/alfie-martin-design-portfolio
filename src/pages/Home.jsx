      ...
      <section className="min-h-screen flex flex-col justify-center px-6 lg:px-12 pt-20">
        <div className="max-w-7xl mx-auto w-full">
          ...
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.4 }} className="text-gray-500 mt-12 text-lg leading-relaxed max-w-md">Multi-disciplinary designer working across branding, digital experiences, and visual storytelling. Based in New York City. Focused on creating things that matter.
