      ...
      <div className="max-w-5xl mx-auto px-6 py-20">
        ...
        <motion.div
          ...
          className="mb-24">
            ...
            <p className="text-xl md:text-2xl leading-relaxed text-slate-700 font-sans max-w-4xl">
                A community-powered mobile app I'm building for people who need help but aren't ready — or willing — to call the authorities. One button. Real people. No system.
            </p>
        </motion.div>

        {/* The Problem */}
        <section className="mb-24">
            <h2 className="text-4xl md:text-5xl font-bold text-[#E15A85] font-serif mb-6">The Problem</h2>
        ...
        <section className="mb-24">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16 text-center">
                <div>
                    ...
                    <p className="text-sm text-slate-600 font-sans">of people in the US do not call 911 during an emergency due to fear of the response</p>
                </div>
                <div>
                    ...
                    <p className="text-sm text-slate-600 font-sans">reduction in likelihood of helping when bystanders believe others will act</p>
                </div>
                <div>
                    ...
                    <p className="text-sm text-slate-600 font-sans">apps exist that address both problems simultaneously at the community level</p>
                </div>
                <div>
                    ...
                    <p className="text-sm text-slate-600 font-sans">is all I believe it should take to reach the people around you</p>
                </div>
            </div>

            <p className="text-lg md:text-xl text-slate-700">
                The product logic is intentionally minimal. Complexity is friction, and friction costs time. I designed the core flow so that a person under stress — potentially impaired, scared, or in a public setting where they need to be discreet — can activate help in a single gesture.
            </p>
        </section>
        ...
        {/* Core Design Problem */}
        <section className="mb-24">
            <h2 className="text-4xl md:text-5xl font-bold text-[#E15A85] font-serif mb-6">Core Design Problem</h2>
            <div className="inline-block bg-[#E5DDF5] text-[#553696] text-xs font-bold tracking-wider px-3 py-1 mb-8 rounded uppercase font-sans">
                KILLING THE BYSTANDER EFFECT
            </div>
            
            <div className="border-l-4 border-[#6A42C1] pl-6 py-2 mb-10 text-xl md:text-2xl font-serif text-slate-800 italic">
            ...
            <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="p-8 md:p-10 bg-[#6A42C1] text-white rounded-lg shadow-xl">
                    <h3 className="text-2xl font-serif font-bold text-white mb-6">With ADINA</h3>
        ...
        {/* Design Philosophy */}
        <section className="mb-24">
            <h2 className="text-4xl md:text-5xl font-bold text-[#E15A85] font-serif mb-6">Design Philosophy</h2>
            <div className="inline-block bg-[#E5DDF5] text-[#553696] text-xs font-bold tracking-wider px-3 py-1 mb-8 rounded uppercase font-sans">
                COMMUNITY, NOT SYSTEM
            </div>
            <p className="text-lg md:text-xl text-slate-700 mb-12">
                I made a deliberate choice not to integrate with emergency services, and I want to be clear that this wasn't an oversight or a feature I'm planning to add later. The decision to exclude authority systems from the product loop is the product. The entire value proposition rests on it.
            </p>

            <div className="grid md:grid-cols-2 gap-8 mb-12">
                <div className="p-8 md:p-10 bg-white rounded-lg border border-gray-200 shadow-sm">
                    <h3 className="text-2xl font-serif font-bold text-[#E15A85] mb-6">Calling 911 requires</h3>
                    <ul className="list-disc pl-6 space-y-4 text-slate-700 font-sans text-lg">
                ...
                <div className="p-8 md:p-10 bg-[#6A42C1] text-white rounded-lg shadow-xl">
                    <h3 className="text-2xl font-serif font-bold text-white mb-6">ADINA requires</h3>
                    <ul className="list-disc pl-6 space-y-4 text-white/90 font-sans text-lg">
            ...
            <p className="text-lg md:text-xl text-slate-700">
                I am not building an alternative to emergency services for emergencies that require them. I am building an alternative to <em>nothing</em> — the current option available to people whose situations don't fit the existing model. That is a large population, and it has been underserved by product design for a long time.
            </p>
        </section>

        {/* Key Design Decisions */}
        <section className="mb-24">
            <h2 className="text-4xl md:text-5xl font-bold text-[#E15A85] font-serif mb-6">Key Design Decisions</h2>
            <div className="inline-block bg-[#E5DDF5] text-[#553696] text-xs font-bold tracking-wider px-3 py-1 mb-8 rounded uppercase font-sans">
                EVERY CHOICE WAS INTENTIONAL
            </div>
            <p className="text-lg md:text-xl text-slate-700 mb-12">
                Building a product in this space means that design decisions carry real weight. Getting the privacy model wrong, or the interaction wrong, or the information architecture wrong doesn't result in a bad product review — it results in someone being harmed. I treated every decision accordingly.
            </p>
        ...
        <section className="mb-24">
            <h2 className="text-4xl md:text-5xl font-bold text-[#E15A85] font-serif mb-6">What I'm Testing Right Now</h2>
            ...
            <div className="text-lg md:text-xl text-slate-700 space-y-6 mb-12">
                <p>ADINA is currently in early testing. The core loop — alert, notify, respond, display — is functional. What I'm focused on in this phase is less about feature validation and more about trust and activation rate. A safety product lives or dies on whether people actually have it installed before they need it, and whether they trust it enough to use it when they do.</p>
                <p>I'm testing with a small, closed group across different neighborhood types — dense urban, mid-density residential, and transit-heavy corridors — to understand how geographic density affects the product's core utility. A tool that alerts nearby users only works if there are nearby users.</p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-[#E5DDF5] p-8 rounded-lg flex flex-col">
                    ...
                    <p className="text-slate-700 font-sans text-lg">Core alert loop. Single-button activation. Geolocation notification to nearby users.</p>
                </div>
                <div className="bg-[#E5DDF5] p-8 rounded-lg flex flex-col">
                    <h3 className="font-serif font-bold text-xl mb-3 text-slate-900">☐ Active Now — Closed Beta</h3>
                    <p className="text-slate-700 font-sans text-lg">Response visibility feature live. Testing trust, activation rates, and density thresholds across neighborhood types.</p>
                </div>
                <div className="bg-[#E5DDF5] p-8 rounded-lg flex flex-col">
                    <h3 className="font-serif font-bold text-xl mb-3 text-slate-900">→ Upcoming Open Beta</h3>
                    <p className="text-slate-700 font-sans text-lg">Expanding user base. Community building tools. Onboarding to increase passive install base in target areas.</p>
                </div>
            </div>
        </section>
        ...
        <section className="mb-24">
            <h2 className="text-4xl md:text-5xl font-bold text-[#E15A85] font-serif mb-12">What I don't Know Yet</h2>
            <div className="space-y-10">
                <div>
                    <h3 className="text-2xl font-bold text-slate-900 mb-4 font-serif">What is the minimum viable community density?</h3>
                    <p className="text-slate-700 text-lg md:text-xl">The product requires a critical mass of installed users within a given radius to function. I don't yet know what that number is, or how it changes by geography, time of day, or context type.</p>
                </div>
                <div>
                    ...
                    <p className="text-slate-700 text-lg md:text-xl">People install safety tools reactively, after a close call. The challenge is getting the app installed in advance which means building ambient community value beyond the emergency use case.</p>
                </div>
                <div>
                    <h3 className="text-2xl font-bold text-slate-900 mb-4 font-serif">What does a false alert do to community trust?</h3>
                    <p className="text-slate-700 text-lg md:text-xl">The press-and-hold gesture reduces accidental activations, but I'm watching early testing data closely to understand how even a small rate of false alerts affects whether community members stay engaged and responsive.</p>
                </div>
                <div>
                    ...
                    <p className="text-slate-700 text-lg md:text-xl">There will be cases where the right response is emergency services, even for people who didn't want to call. The product needs a design-level answer to this that doesn't undermine its core promise.</p>
                </div>
                <div>
                    <h3 className="text-2xl font-bold text-slate-900 mb-4 font-serif">What is the right expansion model?</h3>
                    <p className="text-slate-700 text-lg md:text-xl">Building community-first means geographic growth has to be intentional and density-aware. I'm still developing the playbook for how to launch in a new area without launching before the network is thick enough to work.</p>
                </div>
            </div>
        </section>
