...
export default function MultiMedia() {
  ...
  { src: "https://media.base44.com/images/public/6974e154f708f4918a2b8d02/e6a55c32f_MonochromeMinimalistScrapbookFashionBrandPhotoCollageInstagramPost.png", caption: "Fashion Brand Collage" },
  ...
  return (
    <div className="min-h-screen bg-[#faf9f6]">
      ...
      <div className="pt-16 pb-16 px-6 lg:px-12">
        ...
        <div className="mt-32">
          <div className="mb-10">
            <h2 className="text-3xl font-serif text-slate-900">Brand Identity, Fashion, Illustration Creative  </h2>
          </div>
