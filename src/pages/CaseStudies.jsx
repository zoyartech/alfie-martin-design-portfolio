...
const caseStudies = [
  {
    ...
    problem: "Polaroid returned to the market with new challenges and a brand identity that was positioned to 'everyone.' As famous marketer Seth Godin states, 'When marketing to everyone you market to no one.' The brand needed to redefine its positioning to connect with a specific audience and stand out in a competitive instant photography market.",
