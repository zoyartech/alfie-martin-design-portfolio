        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:flex items-center space-x-10">
              ...
              <Link to={createPageUrl("Gallery")} className="text-xs tracking-[0.2em] text-gray-500 hover:text-black transition-colors">VISUALS</Link>
      ...
      <div className="pt-24 min-h-screen flex flex-col justify-center">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 w-full">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <h2 className="text-4xl md:text-5xl font-light mb-6 max-w-4xl">Design Sprint & Hackathon</h2>
              <p className="text-gray-500 max-w-3xl text-lg leading-relaxed">
                Documentation and results from recent rapid-prototyping initiatives.
              </p>
            </motion.div>
        </div>
      </div>
