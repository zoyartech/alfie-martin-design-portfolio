...
import { ArrowLeft, ArrowRight, X, Info, Check, AlertCircle, Volume2, ChevronUp, ChevronDown, Sparkles, Mic, Activity, BrainCircuit, ShieldCheck, UserCog, History, Play, SquareTerminal, CheckCircle2 } from "lucide-react";
  ...
  const startNLU = () => {
    ...
    setTimeout(() => {
      setNluData({
        ...
        confidence: 0.987,
        entities: { target: "motor_threshold", value: 62, unit: "percent" },
        action_tier: 2,
        ...
        <div>
          ...
          {activeTab === "overview" &&
            <motion.div
              ...
              <div className="bg-slate-900 rounded-3xl p-8 md:p-12 text-slate-100 shadow-2xl">
                <div className="max-w-5xl mx-auto flex flex-col items-center gap-8 md:gap-12 mb-16">
                ...
                <div className="mb-16">
                  <h2 className="text-2xl font-medium mb-6">Voice Analytics</h2>
                ...
                <div className="text-center">
                  ...
                  <p className="text-lg text-slate-400 font-light mb-8 max-w-3xl mx-auto">
          ...
          {activeTab === "simulation" &&
            <motion.div
              ...
              <div className="bg-slate-950 rounded-3xl p-8 md:p-12 text-slate-200 shadow-2xl">
                <div className="mb-12">
                  <h2 className="text-3xl md:text-4xl font-semibold text-white tracking-tight mb-4">Voice Pipeline Simulation</h2>
