    ...
    <div className="min-h-screen bg-white font-sans text-slate-900 selection:bg-blue-100 selection:text-blue-900 pb-24">
      ...
      <section className="py-24 px-6 lg:px-12">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-20 w-full flex justify-center">
            <img src="https://media.base44.com/images/public/6974e154f708f4918a2b8d02/1d22437e9_Screenshot2026-04-14at74930PM.png" alt="Intent resolution layer" className="w-full max-w-4xl rounded-2xl shadow-sm border border-slate-200 object-contain" />
          </div>
