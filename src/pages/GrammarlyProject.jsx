        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <img
              ...
              className="w-full h-full object-cover shadow-lg hover:scale-105 transition-transform duration-500 cursor-pointer border-[0.5px] border-black"
            />
          </motion.div>
        </div>
      </section>
      ...
      <section className="pt-8 pb-16 px-6 lg:px-12">
        <div className="max-w-4xl mx-auto space-y-16">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="aspect-video overflow-hidden bg-white -mx-6 lg:-mx-12 scale-[1.57] hover:scale-[1.67] transition-transform duration-500 cursor-pointer"
          >
            <img
