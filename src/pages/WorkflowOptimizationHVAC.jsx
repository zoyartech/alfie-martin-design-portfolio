    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="pt-24">
        ...
        <section className="py-8 px-6 lg:px-12">
            <div className="max-w-7xl mx-auto">
                <img loading="lazy" src="https://media.base44.com/images/public/6974e154f708f4918a2b8d02/229315afd_2-ratio-1-outdoor-billboard-mockup-template-69bbedce2b60532d8c62109f-2x.png" alt="Dashboard Design" className="w-full h-auto object-contain rounded-lg" />
            </div>
        </section>
