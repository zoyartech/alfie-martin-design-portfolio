        ...
        <motion.article
          ...
          <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-light">
            ...
            <div className="space-y-6">
              ...
              <p className="mb-6 text-lg">Wittgenstein is oddly relevant. His claim that “meaning” is use, that we don't grasp meaning by pointing to referents but by mastering language games. This is basically what a transformer does. Imagine learning all the moves without ever touching the worl?. The fact that LLMs work at all is a partial justification of his view; the fact that they “hallucinate” is am excellentt defense on the part where he mentions language games are embedded in forms of life, that is a huge thing however that LLMs lack. Walter Benjamin would have said that generative AI is "The Work of Art in the Age of Mechanical Reproduction" basically wrote the viral post thirty years before the technology existed. Pair him with Baudrillard on simulacra: AI output is the limit case of his fourth-order simulation, where signs refer to nothing but other signs. Things like deepfakes, synthetic media, training data eating its own tail like the weird ouraboras symbol.
