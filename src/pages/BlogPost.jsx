        ...
        <motion.article
          ...
          <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-light">
            ...
            <div className="space-y-6">
              ...
              <p className="mb-6 text-lg font-medium">There are forms of social capital the ultra-wealthy cannot buy, and the inability rankles them. They notice it in their staff and in the artists they commission — the housekeeper who moves through the world without performance, the painter who walks into the room already belonging to something the patron will never be admitted to. What they covet most is precisely what their money cannot reach: ease, lineage, the unforced confidence of a life that did not have to be assembled. They can hire the people who have it. They cannot become them. And so the resentment runs underneath the relationship like a current, dressed up as taste, dressed up as discernment, dressed up as anything other than what it is.
