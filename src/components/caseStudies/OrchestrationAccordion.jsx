          ...
          <div key={index} className={index > 0 ? '-mt-px' : ''}>
            <h3 className="m-0">
              <button
                ...
                className={`flex items-center justify-between gap-4 w-full box-border border border-slate-900 px-2.5 py-2.5 text-left cursor-pointer transition-colors duration-200 ${
                  isOpen ? 'bg-[#fff2a4]' : 'bg-white'
                }`}
              >
                <span className="font-wexley text-xl md:text-[2.125rem] leading-none font-normal text-slate-900 max-w-full break-words">
                  {row.title}
                </span>
                ...
                >
                  <div className="flex flex-wrap items-start gap-2.5 pt-2.5 pb-2.5">
                    ...
                    <div className="flex-1 min-w-[12rem] overflow-hidden">
                      <p className="m-0 text-sm leading-5 text-slate-600 break-words">
                        {row.body}
                      </p>
                    </div>
                  </div>
