  ...
  return (
    <div className="w-full font-sans">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        {/* Session Usage */}
        <div className="bg-blue-950 p-6 rounded-2xl lg:col-span-3 border border-slate-200 shadow-sm">
          <h4 className="text-slate-100 mb-6 text-sm font-semibold">Weekly Usage Frequency</h4>
