      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="text-foreground hidden md:flex items-center gap-10">
            ...
            <Link
              to={createPageUrl("MultiMedia")} className="text-foreground text-xs font-bold tracking-[0.15em] relative transition-colors group hover:text-slate-500">
              MULTIMEDIA
              <span className={`absolute -bottom-2 left-0 h-[2px] transition-all duration-300 bg-foreground ${path === 'MultiMedia' ? 'w-full' : 'w-0 group-hover:w-full'}`}></span>
            </Link>
            <Link
            ...
            <a
              href="https://medium.com/@alfieaiproductdesign" target="_blank" rel="noopener noreferrer" className="text-foreground text-xs font-bold tracking-[0.15em] relative transition-colors group hover:text-slate-500">
              BLOG
